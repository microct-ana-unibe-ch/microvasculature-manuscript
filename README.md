...
[![DOCX Manuscript](https://img.shields.io/badge/manuscript-DOCX-blue.svg)](https://github.com/microct-ana-unibe-ch/microvasculature-manuscript/raw/output/manuscript.docx)
...
When a commit to the `main` branch occurs (for example, when a pull request is merged), CI builds the manuscript and writes the results to the [`gh-pages`](https://github.com/microct-ana-unibe-ch/microvasculature-manuscript/tree/gh-pages) and [`output`](https://github.com/microct-ana-unibe-ch/microvasculature-manuscript/tree/output) branches.
The `gh-pages` branch uses [GitHub Pages](https://pages.github.com/) to host the following URLs:

+ **HTML manuscript** at https://microct-ana-unibe-ch.github.io/microvasculature-manuscript/
+ **PDF manuscript** at https://microct-ana-unibe-ch.github.io/microvasculature-manuscript/manuscript.pdf
...
Please attribute by linking to https://github.com/microct-ana-unibe-ch/microvasculature-manuscript.
...
Please open [an issue](https://github.com/microct-ana-unibe-ch/microvasculature-manuscript/issues) for any question related to licensing.
