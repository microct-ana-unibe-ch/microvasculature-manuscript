...
header-includes: |
  ...
  <meta name="dc.modified" content="2024-07-22T12:34:58+00:00" />
  <meta property="article:modified_time" content="2024-07-22T12:34:58+00:00" />
  ...
  <link rel="alternate" type="text/html" href="https://microct-ana-unibe-ch.github.io/microvasculature-manuscript/v/78debba1293dfec27c5715487b88afc10305dff2/" />
  <meta name="manubot_html_url_versioned" content="https://microct-ana-unibe-ch.github.io/microvasculature-manuscript/v/78debba1293dfec27c5715487b88afc10305dff2/" />
  <meta name="manubot_pdf_url_versioned" content="https://microct-ana-unibe-ch.github.io/microvasculature-manuscript/v/78debba1293dfec27c5715487b88afc10305dff2/manuscript.pdf" />
  <meta property="og:type" content="article" />
...
([permalink](https://microct-ana-unibe-ch.github.io/microvasculature-manuscript/v/78debba1293dfec27c5715487b88afc10305dff2/))
was automatically generated
from [microct-ana-unibe-ch/microvasculature-manuscript@78debba](https://github.com/microct-ana-unibe-ch/microvasculature-manuscript/tree/78debba1293dfec27c5715487b88afc10305dff2)
on July 22, 2024.
Changes to the submitted version are visualized [here on GitHub](https://github.com/microct-ana-unibe-ch/microvasculature-manuscript/compare/v1.0...78debba1293dfec27c5715487b88afc10305dff2#files_bucket).
</em></small>
...
The minor contrast difference between the perfusion agent to generate the replica of the vascular network an the mineralized bone makes it problematic to distinguish bone tissue and vasculature.
...
Such a decalcification procedure makes simultaneous assessment of bone microstructure and vascular morphology impossible [@doi:10.1038/s41598-017-13632-5].
Although in a recent study of Rosenblum et al. [@doi:10.1016/j.crmeth.2021.100151], in a small animal model study without biomedical implants, it was shown that this limitation can be overcome by iterative microCT-imaging (pre- and post-decalcification).
...
It is thus of a paramount importance to develop an imaging method for the assessment of tumor vasculature in the bone without decalcification, which renders bone microstructure X-ray transparent.
...
Implantology and osteology studies are often conducted in large animal models rendering the corresponding imaging even more complicated due to the lack of transgenic lines as well as a larger size of the harvested samples.
...
Moreover, we show that the polymer-based contrast agent µAngiofil is suitable for simultaneous imaging and subsequent analysis of peri-implant hard and soft tissues as well as their vascularization in the vicinity of metal implants in a large animal model.
...
Heparinized animals were deeply anesthetized, the thorax and the peritoneal cavity were opened with scissors to expose the descending aorta.
...
After µAngiofil polymerization we fixed the samples in 4% paraformaldehyde (PFA) solution at 4° C and stored in PFA until tomographic imaging.
...
This resulted in an isometric voxel size of 2.99 µm.
...
This resulted in an isometric voxel size of 1.65 µm.
...
This resulted in an isometric voxel size of 1 µm.
...
The X-ray absorption characteristics of µAngiofil make it possible to visualize and differentiate between soft tissue, bone tissue, contrast agent-filled vessels as well as metal (titanium) implants.
We imaged an µAngiofil-instilled minipig hemimandibula with a SKYSCAN 2214 (Fig. @fig:6), with an X-ray source acceleration voltage of 100 kV and an X-ray source current of 100 µA.
...
Importantly, hydroxyapatite (the mineral in bone bone and teeth) versus iodine (the high-Z component in µAngiofil) offer optimal properties for spectral X-Ray imaging [@doi:10.1111/jmi.12543; @doi:10.1007/s13244-010-0057-0; @doi:10.1118/1.594374].
...
![**Dual energy microangioCT of a murine mandibula.**
  Panel A and B represent virtual sections through the microCT-datasets obtained at different accelerating voltage: 50 kV (A) and 90 kV (B).
...
To properly distinguish the vasculature from other soft tissue structures, instillation of a contrast agent or producing a vascular replica is necessary.

Our hereby presented method of imaging the microvasculature within bones based on instillation with µAngiofil overcomes several drawbacks of previously described methods (see [Introduction]).
...
Such a decalcification step enables tomographic imaging of the murine hind limb vasculature with less artifacts around the bone at lower acceleration voltages of the X-ray source due to the reduced radiopacity of the sample.
...
But the decalcification step renders bone tissue transparent, disabling simultaneous 3D imaging of the bony and vascular structures.
...
In such cases we are able to assess vascularization and bone growth directly in one scan (Fig. @fig:6).
...
This greatly simplifies the registration of the obtained datasets, is much faster than with the decalcification step, provides concurrent imaging of the bone tissue and the sample remains completely intact.
Therefore, the microangioCT approach we present here can be used for simultaneous visualization of hard and soft tissues and their vascularization in small and large animal models.
...
The potential findings can be crucial for selecting potential drug candidates and proper treatment decision and efficacy prediction.
...
Namely;
  ...
  ii) limited imaging depth (around 800 µm in a mouse model [@doi:10.1111/cpr.12578]) due to the challenges of achieving complete transparency of bone tissue.
...
µAngiofil has noticeably different attenuation than mineralized bone in most species and allows for distinction, segmentation and visualization of soft tissue, bone tissue, vessels filled with the contrast agent as well as metal implants according to their gray values in the histogram (Fig. @fig:6).
...
If the sample is only a few millimeters in diameter, the voxel sizes in the range of 1 µm enable visualization of the microvasculature down to the capillary bed
