...
![**microAngioCT of a xenograft tumor implanted into tibia of 6-week-old CB17SCID male mice.**
  ...
  Besides irregularly patterned tumor vessels (in B & C) further bony structures like the growth plate or calcified parts of the medial meniscus (MM) are clearly distinguishable.](images/Fig3_tumor tibia.png){#fig:3}
...
![**microAngioCT of the minipig mandibula.**
  ...
  Due to the voxel size of 8--9 μm, microvessels with a diameter of 40 μm or less cannot be visualized in such large samples.](images/Fig5_Vreni jaw minipig.png){#fig:5}
