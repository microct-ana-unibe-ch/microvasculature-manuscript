...
![](media/image1.jpeg){width="6.299305555555556in" height="4.156944444444444in"}
...
Scanning parameters (SKYSCAN 1172): acceleration voltage 50 kV, current 200 µA, 2.98 µm voxel size, 360 degrees scan, 0.05° rotation step, frame averaging 3.
...
![](media/image2.png){width="6.3in" height="6.455555555555556in"}Fig 2.
...
Scanning parameters (SKYSCAN 1172): acceleration voltage 59 kV, current 167 µA, 0.2 mm aluminum filter, 3.19 µm voxel size, 180 degrees scan, 0.1° rotation step, frame averaging 2.
...
![](media/image3.png){width="6.475in" height="4.688888888888889in"}
...
Scanning parameters (SKYSCAN 1272): acceleration voltage 60 kV, current 166 µA, 0.2 mm aluminum filter, 1.65 µm voxel size, 360 degrees scan, 0.1° rotation step, frame averaging 3.
...
![](media/image4.jpeg){width="4.1506944444444445in" height="8.346527777777778in"}**Fig.
4.
...
Scanning parameters (SKYSCAN 1172): accelerating voltage 80 kV, voxel size 1.0 µm, 0.2 mm aluminum filter, rotation step 0.1°, 360 degrees scan, frame averaging 4.
...
![](media/image5.jpeg){width="6.3in" height="6.381944444444445in"}**Fig 5.
MicroangioCT of the minipig mandibula.** Panel A displays the visualization of a right minipig hemimandible: the vasculature at the bone surface is clearly visible.
...
Due to the voxel size of 8-9 µm, the microvessels with diameter of approx.
40 µm or less cannot be visualized in such large samples.
...
![](media/image6.jpeg){width="6.226388888888889in" height="3.932638888888889in"}**Fig 6.
MicroangioCT of the peri-implant vasculature of a minipig mandibula.** Panel A displays a MIP image of the minipig mandible with 4 metal implants and µAngiofil--perfused vessels.
...
Scanning parameters (SKYSCAN 2214): accelerating voltage 100 kV, voxel size 8.0 µm, 1 mm copper filter, rotation step 0.18°, 360 degrees scan, frame averaging 4.