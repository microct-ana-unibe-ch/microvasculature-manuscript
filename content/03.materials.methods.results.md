...
After μAngiofil polymerization we fixed the samples in 4% paraformaldehyde (PFA) solution at 4° C and stored in PFA until tomographic imaging.
...
Prior to terminal anesthesia and perfusion with μAngiofil as described above, the hind limb of interest was X-rayed using Faxitron Bioptics as a standard follow-up in this model (see insert in Fig. @fig:3, Panel A).
...
Importantly, hydroxyapatite (the mineral in bone bone and teeth) versus iodine (the high-Z component in μAngiofil) offer optimal properties for spectral X-Ray imaging [@doi:10.1111/jmi.12543; @doi:10.1007/s13244-010-0057-0; @doi:10.1118/1.594374].
