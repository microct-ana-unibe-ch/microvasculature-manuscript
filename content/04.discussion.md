...
The microCT scan of correspondingly small samples perfused with μAngiofil can be performed with a voxel size around 1 μm, providing excellent detail resolution (Fig. @fig:4).
...
In case of large samples, like minipig hemimandible, the achievable voxel size is approximately 10 times larger (≥8 μm).
